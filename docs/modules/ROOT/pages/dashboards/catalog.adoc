...
Dynatrace now provides the primary Redis Enterprise experience through the published `Redis Enterprise - Prometheus` extension in Dynatrace Hub.

=== Current Path

* *Source*: Dynatrace Hub `Redis Enterprise - Prometheus`
* *Description*: Supported extension lifecycle, activation, and vendor-managed dashboards
* *Features*: Full-stack observability, Davis AI integration, published extension updates

=== Legacy Repository Assets

* *Directory*: `dynatrace_v2/legacy/gen-3-dashboards/`
* *Description*: Historical generated dashboard exports
* *Directory*: `dynatrace_v2/legacy/src/`
* *Description*: Historical extension source and dashboard JSON

=== Dynatrace Kickstarter

* *Directory*: `dynatrace_v2/kickstarter/`
* *Description*: ActiveGate bootstrap for AWS and GCP, plus optional CA installation
* *Scope*: Does not upload the extension or create monitoring configurations

See the https://github.com/redis-field-engineering/redis-enterprise-observability/tree/main/dynatrace_v2[dynatrace_v2 README^] for the current workflow and legacy notes.
...
* *Description*: Ready-to-use Datadog monitoring setup using the official `redis-enterprise-prometheus` integration
